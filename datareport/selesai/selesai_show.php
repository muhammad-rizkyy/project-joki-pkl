  ...
  <div class="col">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Data Permohonan Selesai</h6>

      </div>
      <div class="card-body">
        <div class="row d-flex justify-content-between align-items-center">
          <div class="col">
            <a href="../datareport/selesai/selesai_print2.php" class="btn btn-sm btn-warning" target="_blank"><i class="fas fa-print"></i>
              Cetak
              Data</a>
          </div>
          <div class="col">
            <form action="../datareport/selesai/selesai_print1.php" method="get" target="_blank">
              <div class="row">
                <div class="col">
        ...
        <div class="table-responsive mt-3">
          <table class="table table-bordered table-hover" id="viewData" style="width: 100%">
            ...
            <tbody>
              <?php
              include '../connection.php';
              $query = mysqli_query($con, 'SELECT * FROM data_permohonan WHERE status = 5; ');
              while ($data = mysqli_fetch_array($query)) { ?>
