...
if ($update) {
  echo "<script>window.location.href = '?page=revisi-show';</script>";
} else echo 'gagal';
// echo "<script>win
}
?>
  ...
  <div class="col">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Edit Data Revisi</h6>
          ...
          <div class="row">
            <div class="offset-sm-2">
              ...
              <button type="submit" class="btn btn-sm btn-primary" name="submit"><i class="fas fa-save"></i>
                Ubah</button>
              <a href="?page=revisi-show" class="btn btn-sm btn-danger"><i
